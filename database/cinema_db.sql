...
INSERT INTO `movietable` (`movieID`, `movieImg`, `movieTitle`, `movieGenre`, `movieDuration`, `movieRelDate`, `movieDirector`, `movieActors`, `mainhall`, `viphall`, `privatehall`) VALUES
(2, "img/movie-poster-2.jpg", "Bohemian Rhapsody", "Biography, Musical", "144", "2018-10-24", "Bryan Singer, Dexter Fletcher", "Rami Malek, Lucy Boynton", 0,0,0);
use cinema_db;
INSERT INTO `movietable` (`movieID`, `movieImg`, `movieTitle`, `movieGenre`, `movieDuration`, `movieRelDate`, `movieDirector`, `movieActors`, `mainhall`, `viphall`, `privatehall`) VALUES
(4, "img/movie-poster-4.jpg", "Inception", "Drama, Sci-Fi", "158" ,"2010-07-22", "Christopher Nolan", "Leonardo DiCaprio, Ken Watanabe" , 0,0,0);
