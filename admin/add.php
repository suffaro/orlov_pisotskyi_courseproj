...
<body>
    <?php
    $link = mysqli_connect("localhost", "root", "Suma1l24_", "cinema_db");
                    ...
                    <div class="booking-form-container">
                        <form action="spot.php" method="POST">
                            ...
                            <select name="date" required>
                                ...
                                <option value="12-3">July 12,2023</option>
                                <option value="13-3">July 13,2023</option>
                                <option value="14-3">July 14,2023</option>
                                <option value="15-3">July 15,2023</option>
